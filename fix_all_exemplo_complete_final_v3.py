...
def create_comprehensive_examples():
    ...
    better_examples = {
        ...
        "actuación": {
            "example": "La actuación del actor fue excelente",
            "exampleTranslation": "A atuação do ator foi excelente",
            "exampleEnglish": "The actor's performance was excellent"
        },
        "actual": {
            "example": "La situación actual es preocupante",
            "exampleTranslation": "A situação atual é preocupante",
            "exampleEnglish": "The current situation is worrying"
        },
        "actualidad": {
            "example": "La actualidad noticiosa es muy interesante",
            "exampleTranslation": "A atualidade noticiosa é muito interessante",
            "exampleEnglish": "Current news is very interesting"
        },
        "actualización": {
            "example": "La actualización del software es necesaria",
            "exampleTranslation": "A atualização do software é necessária",
            "exampleEnglish": "Software update is necessary"
        },
        "actualizar": {
            "example": "Voy a actualizar mi perfil",
            "exampleTranslation": "Vou atualizar meu perfil",
            "exampleEnglish": "I'm going to update my profile"
        },
        "actuar": {
            "example": "Voy a actuar en la obra de teatro",
            "exampleTranslation": "Vou atuar na peça de teatro",
            "exampleEnglish": "I'm going to act in the play"
        },
        "acuarela": {
            "example": "La acuarela es una técnica de pintura",
            "exampleTranslation": "A aquarela é uma técnica de pintura",
            "exampleEnglish": "Watercolor is a painting technique"
        },
        "acuarelista": {
            "example": "El acuarelista pinta paisajes hermosos",
            "exampleTranslation": "O aquarelista pinta paisagens lindas",
            "exampleEnglish": "The watercolorist paints beautiful landscapes"
        },
        "acuario": {
            "example": "El acuario tiene muchos peces coloridos",
            "exampleTranslation": "O aquário tem muitos peixes coloridos",
            "exampleEnglish": "The aquarium has many colorful fish"
        }
    }
