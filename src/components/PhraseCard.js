      ...
      <div className="phrase-card-simple" onClick={handleOpenModal}>
        ...
        {phrase.phonetic && (
          <div className="phonetic-section">
            ...
            {getPhoneticExplanation(phrase.phonetic) && (
              <div className="phonetic-explanation">
                {getPhoneticExplanation(phrase.phonetic).map((explanation, index) => (
                  <p key={index} className="explanation-item">{explanation}</p>
                ))}
                <p className="phonetic-result">
                  Então /{phrase.phonetic}/ = "{phrase.phonetic.replace(/[.ˈ]/g, '-').toLowerCase()}" ({getOriginalText()})
                </p>
              </div>
            )}
          </div>
